...
// 운용모드(ecb mode)
void encrypt8_cbc(uint8_t *k, uint8_t *a, uint8_t *IV, uint8_t n)
{
    uint8_t c[16] = {
        0,
    };
...
void decrypt8_cbc(uint8_t *k, uint8_t *a, uint8_t *IV, uint8_t n)
{
    uint8_t c[32] = {
        0,
    };
